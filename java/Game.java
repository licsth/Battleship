...
public class Game {
    ...
    private static long getBoundary(long ship, int size) {
        long boundary = 0L;
    ...
    public static boolean isShipPositionValid(long missedShots, long hitShips, long sunkShips, long ship, long boundary) {
